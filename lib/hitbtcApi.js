...
var hitbtcApi = /** @class */ (function () 
{
    ...
    hitbtcApi.prototype.getCandles = function (symbol)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.get(this.apiURL + '/public/candles/' + symbol + '?sort=desc&limit=4', {json:true}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.createOrder = function (body)
    {
    ...
    hitbtcApi.prototype.getMarginAccounts = function ()
    {
        
        return new Promise((resolve, reject) => {
            
            request.get(this.apiURL + '/margin/account', {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.getMarginAccount = function (symbol = null)
    {
        
        return new Promise((resolve, reject) => {
            
            request.get(this.apiURL + '/margin/account/' + symbol, {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.getMarginPositions = function ()
    {
        
        return new Promise((resolve, reject) => {
            
            request.get(this.apiURL + '/margin/position', {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.getMarginPosition = function (symbol = null)
    {
        
        return new Promise((resolve, reject) => {
            
            request.get(this.apiURL + '/margin/position/' + symbol, {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.getActiveMarginOrders = function (symbol = null)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.get(this.apiURL + '/margin/order' + extra, {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.getActiveMarginOrder = function (clientOrderId = null)
    {
        
        return new Promise((resolve, reject) => {
            
            request.get(this.apiURL + '/margin/order/' + clientOrderId, {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.cancelMarginOrder = function (clientOrderId = null)
    {
        ...
        return new Promise((resolve, reject) => {
        	...
        	{
        		extra = "&clientOrderId=" + clientOrderId;
        	}
        	else
        	{
        		reject("missing client order id"); return;
        	}
            
            request.delete(this.apiURL + '/margin/order/' + clientOrderId, {json:true, headers:{"Authorization" : this.auth}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.cancelMarginOrderBySymbol = function (symbol = null)
    {
        ...
        return new Promise((resolve, reject) => {
        	...
        	if (symbol == null)
        	{
        		reject("missing symbol"); return;
        	}
            
            request.delete(this.apiURL + '/margin/order', {json:true, headers:{"Authorization" : this.auth}, body: {symbol: symbol}}, function (error, response, body)
            {
    ...
    hitbtcApi.prototype.createMarginOrder = function (body)
    {
        
        return new Promise((resolve, reject) => {
        
            request.post(this.apiURL + '/margin/order', {json:true, headers:{"Authorization" : this.auth}, body:body}, function (error, response, body)
            {
